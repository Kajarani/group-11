	...
	<a class=" btn btn-primary" href="addproduct.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        $result=mysqli_query($conn,"select product_id,product_image, product_name,unit_price from product  where  product_cat=1  Limit $page1,12")or die ("query 1 incorrect.....");
...
//counting paging
                ...
                $paging=mysqli_query($conn,"select product_id,product_image, product_name,unit_price from product");
