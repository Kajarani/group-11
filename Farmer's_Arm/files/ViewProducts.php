...
<head>
    ...
    <title>View Products || Farmer's_Arm</title>
...
$result=mysqli_query($conn,"SELECT product_id, product_name,unit_price,quantity,product_desc from product   order by product_name asc");

while(list($product_id,$product_name,$price,$quantity,$product_desc)=mysqli_fetch_array($result))
{
