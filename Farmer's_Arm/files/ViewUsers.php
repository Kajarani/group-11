...
<head>
    ...
    <title>View Users || Farmer's_Arm</title>
        ...
        <section class="page-header" style="background-image: url(assets/images/backgrounds/bgimage1.jpg);">
            <div class="container">
                ...
                <ul class="thm-breadcrumb list-unstyled">
                    ...
                    <li><span>View Users Details</span></li>
                </ul>
            </div>
        </section>
        <p><div class="content">
                  ...
                  <table class="table table-striped " id="prod">
                    ...
                    <tbody>
                      <?php 
                        ...
                        while(list($id,$email,$username,$password,$address,$role_id)=mysqli_fetch_array($result))
                        {
                        echo "<tr><td>$id</td>
                        <td>$email</td>
                        <td>$username</td>
