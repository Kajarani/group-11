...
<?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO contact_us ( name,email,phone_no,subject,message) VALUES ('$name','$email',' $phone_no','  $subject','$message')";
...
<head>
    ...
    <title>Contact || Farmer's_Arm</title>
...
<body>
    ...
    <div class="page-wrapper">
            ...
            <div class="topbar-one">
                ...
                <div class="container">
                    <div class="topbar-one__left">
                        ...
                        <a href="tel:0913132697"><span class="icon-phone-call"></span>0911234567</a>
                    </div>
                    <div class="topbar-one__middle">
                        <a href="index.html" class="main-nav__logo">
                            <img src="assets/images/resources/logo2.jpg" width="142" height="66" class="main-logo" alt="Awesome Image" />
                        </a>
                    </div>
                    ...
                    <div class="container clearfix">
                        ...
                        <div class="main-nav__main-navigation">
                            <ul class=" main-nav__navigation-box">
                                ...
                                <li class="dropdown">
                                    <a href="http://localhost/group-11/Farmer's_Arm/files/oganic/blog.html">Blogs</a>
        ...
        <section class="page-header" style="background-image: url(assets/images/backgrounds/image3.jpg);">
            <div class="container">
                <h2>Contact Us</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="location_single">
                            <h2>Belihuloya</h2>
                            <p>Farmers' Arm</p>
                            <a href="mailto:needhelp@agrikol.com">needhelp@farmersarm.com</a><br>
                            <a href="tel:666-888-0000">0911234567</a>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="location_single">
                ...
                <div class="row">
                    <div class="col-xl-7">
                        <div class="contact-one__form__wrap">
                            ...
                            <form  method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="contact-one__form">
                    ...
                    <div class="col-xl-5">
                        <div class="have_questions">
                            ...
                            <div class="have_questions_text">
                                <p>There are many problems facing by farmers. We have solution for them. This is great oppurtunity to farmers 
                                    all over the world to take maximum of this service.
                                </p>
                            </div>
                            <div class="have_questions_btn">
                                <a href="file:///C:/xampp/htdocs/group-11/Farmer's_Arm/oganic-organic-food-bootstrap-html-template-2022-02-21-23-53-23-utc/oganic/blog.html" class="thm-btn">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="site-footer_bottom">
            <div class="container">
                <div class="site-footer_bottom_copyright">
                    <p>@ All copyright 2022, <a href="#">FarmersArm.com</a></p>
                </div>
