...
<head>
    ...
    <title>View Complaints || Farmer's_Arm</title>
        ...
        <section class="page-header" style="background-image: url(assets/images/backgrounds/bgimage1.jpg);">
            <div class="container">
                ...
                <ul class="thm-breadcrumb list-unstyled">
                    ...
                    <li><span>View Complaints</span></li>
                </ul>
            </div>
        </section>
        <p><div class="content">
                  ...
                  <table class="table table-striped " id="prod">
                    ...
                    <tbody>
                      <?php 
                        ...
                        $result=mysqli_query($conn,"SELECT * from complaint  order by id asc");

                        while(list($id,$farname,$email,$complaint)=mysqli_fetch_array($result))
                        {
                        echo "<tr><td>$id</td>
                        <td>$farname</td>
                        <td>$email</td>
